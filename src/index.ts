...
import {default as SEBankIDSameDeviceButton} from './components/SEBankIDSameDeviceButton';
...
export {CriiptoVerifyProvider, AuthMethodSelector, AuthMethodSelectorSweden, AuthMethodButton, useCriiptoVerify, QRCode, SEBankIDQRCode, SEBankIDSameDeviceButton};
