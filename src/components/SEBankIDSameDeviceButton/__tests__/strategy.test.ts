...
describe('SEBankID/strategy', function () {
  ...
  it('uses foreground strategy for iOS Instagram', function () {
    const userAgent =
      'Mozilla/5.0 (iPhone; CPU iPhone OS 17_5_1 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Mobile/21F90 Instagram 335.1.8.26.85 (iPhone14,3; iOS 17_5_1; da_DK; da; scale=3.00; 1284x2778; 609775437) NW/3';
